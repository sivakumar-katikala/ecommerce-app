...
@login_required
def success():
    """Stripe redirects the browser here right after payment. This is PURELY
    for UX (clearing the cart, showing the order) — it does NOT finalize the
    order. The webhook below is the only thing that ever marks an order PAID,
    so a customer can't fake a successful order just by visiting this URL."""
